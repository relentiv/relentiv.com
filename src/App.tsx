...
// How long the screen stays fully covered before fading (in seconds)
...
export default function App() {
  ...
  return (
    <div className="antialiased font-sans">
      ...
      {/* Navigation Bar */}
      <nav
        className={`fixed top-0 w-full z-[60] transition-colors duration-300 ${isMobileMenuOpen ? "bg-[#050505] border-transparent" : "bg-deep-forest/90 nav-blur border-b border-white/10"}`}
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex-shrink-0 flex items-center gap-2">
              <span className="text-2xl font-bold tracking-tight text-white flex items-baseline">
                ...
                <span className="relative inline-flex flex-col items-center">
                  <span className="absolute top-[0.2em] w-[0.25em] h-[0.2em] bg-[#E25822]"></span>
                  <span>ı</span>
                </span>
                v
              </span>
            ...
            <div className="hidden lg:flex items-center space-x-10 text-sm font-medium text-gray-300">
              <Link href="/">
      ...
      {/* Mobile Menu Overlay */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[50] lg:hidden bg-[#050505] flex flex-col pt-24 px-6 animate-in fade-in slide-in-from-top-4 duration-300">
          {/* Gradients and Noise */}
          <div className="absolute top-0 left-0 w-full h-2/3 bg-gradient-to-b from-emerald-900/30 to-transparent opacity-80 pointer-events-none"></div>
          ...
          <div className="relative z-10 flex flex-col space-y-8 mt-4">
            <Link href="/">
              <a
                ...
                className="text-4xl font-medium text-white tracking-tight hover:text-emerald-400 transition-colors"
              >
                Home
              </a>
            </Link>
            ...
            <div className="pt-10 border-t border-white/10 mt-8">
              <button
                ...
                className="w-full bg-white text-black px-8 py-4 rounded-2xl text-lg font-medium hover:bg-gray-200 transition-colors flex items-center justify-center gap-2"
              >
                Book a Consultation
                <svg
                  className="w-5 h-5"
          ...
          <div className="grid md:grid-cols-4 gap-12 border-b border-white/10 pb-16">
            <div className="col-span-2">
              ...
              <p className="text-gray-400 max-w-sm mb-8">
                Global technology leaders driving growth through innovation,
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400 text-sm">
                ...
                <li>
                  <a className="hover:text-accent-green" href="#">
                    Industries
                  </a>
                </li>
                <li>
